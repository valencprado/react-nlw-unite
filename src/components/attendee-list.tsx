        ...
        <table className='w-full '>
          <thead>
            <tr className='border-b border-white/10'>
              <th style={{ width: 48 }} className='py-3 px-4 text-sm font-semibold text-left'><input type="checkbox" className='size-4 bg-black/20 rounded border-white/10 h-auto p-0 border-0 text-sm checked:bg-orange-400' name="" id="" /></th>
              ...
              return (<tr key={i} className='border-b border-white/10 hover:bg-white/5'>
                ...
                <td className='py-3 px-4 text-sm text-zinc-300'>
                  <div className='flex flex-col gap-1'>
                    ...
                    <span> Amiguinho feliz</span>
                    <span> amiguinho@hotmail.com</span>
                  </div>
                </td>
                <td className='py-3 px-4 text-sm text-zinc-300'>7 dias atrás</td>
                <td className='py-3 px-4 text-sm text-zinc-300'>3 dias atrás</td>
                <td className='py-3 px-4 text-sm text-zinc-300'>
                  <button className='bg-black/20 border border-white/0 rounded-md p-2.5'>
              ...
              <td className='py-3 px-4 text-sm text-zinc-300 text-right' colSpan={3}>
                <div className='inline-flex items-center gap-8'>
                  ...
                  <div className='flex gap-1.5'>
                    <button className='bg-white/10 border border-white/10 rounded-md p-2.5'>
                      <ChevronsLeft className='size-4' />
                    </button>            <button className='bg-white/10 border border-white/10 rounded-md p-2.5'>
